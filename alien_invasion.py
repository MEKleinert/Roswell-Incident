...
class AlienInvasion:
    ...
    def __init__(self):
        """Initializate the game and create game resources."""
        pygame.init()
        ...
        pygame.display.set_caption("Roswell Incident")
    ...
    def _make_difficulty_buttons(self):
        ...
        self.impossible_button = Button(self, "Impossible")
        ...
        self.impossible_button.rect.top = (
            self.hard_button.rect.top + 1.5*self.hard_button.rect.height)
        self.impossible_button._update_msg_position()
    ...
    def _check_difficulty_buttons(self, mouse_pos):
        ...
        easy_button_clicked = self.easy_button.rect.collidepoint(
                mouse_pos)
        medium_button_clicked = self.medium_button.rect.collidepoint(
                mouse_pos)
        hard_button_clicked = self.hard_button.rect.collidepoint(
                mouse_pos)
        imp_button_clicked = self.impossible_button.rect.collidepoint(
                mouse_pos)
        ...
        elif imp_button_clicked:
            self.settings.difficulty_level = 'impossible'
    ...
    def _check_fleet_edges(self):
        """Respong appropriately if any aliens have reached an edge."""
        for alien in self.aliens.sprites():
